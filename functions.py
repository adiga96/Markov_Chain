...
def testing_DTMC(TP_Matrix,NHC_List):
...
# iteration 1
    n_state = current_state * TP_Matrix
    ...
    # current_state = [NHC_List[i], DTMC_sub_array[i-1][1], DTMC_sub_array[i-1][2], DTMC_sub_array[i-1][3] ]

    # current_state = np.matrix([NHC_List[1], DTMC_sub_array[1][0], DTMC_sub_array[2][0], DTMC_sub_array[3][0]])

    # return print(DTMC_sub_array[0][1],DTMC_sub_array[2][1],DTMC_sub_array[3][1])
    ...
    for i in range(1, len(NHC_List)):
        ...
        # print(i)
        # print([NHC_List[i], DTMC_sub_array[1][i-1], DTMC_sub_array[2][i-1], DTMC_sub_array[3][i-1]])
